...
[![LlamaIndex](https://img.shields.io/badge/%F0%9F%A6%99%20llama_index-fff?style=for-the-badge)](https://www.llamaindex.ai/)
...
| Description | Tech | TeamSize | Period | Repository | Prize |
| ------ | ------ | ------ | ------ | ------ | ------ |
| LLM 챗봇이 적용된 지도기반 메타버스 SNS (우리가족섬) | Langchain, OpenAI(GPT-4-turbo), FastAPI, Selenium, BeautifulSoup4, MongoDB | ![Team](https://img.shields.io/badge/7-Team-CD1818) | ![Static Badge](https://img.shields.io/badge/2-month-1363DF) | [![Static Badge](https://img.shields.io/badge/Organiztion-gray)](https://github.com/WooriIsland/ai)<br>[![Static Badge](https://img.shields.io/badge/AI_Server-My-713ABE)](https://github.com/Blessian/wooriisland) | <div align="center">[🏆](https://github.com/Blessian)</div> |
...
| 한강 위에서 사람들을 구하는 LLM 적용 자율주행 로봇 | Raspberry Pi 5, OpenAI(GPT-4o-mini, TTS), FastAPI, SQLAlchemy, MQTT, OpenCV, Mediapipe | ![Team](https://img.shields.io/badge/3-Team-CD1818) | ![Static Badge](https://img.shields.io/badge/3-week-47B5FF) | [![Static Badge](https://img.shields.io/badge/Repo_Link-713ABE)](https://github.com/Blessian/gyeonggi_robotics_final_project) |  |
