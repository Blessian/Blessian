...
| ------ | ------ | ------ | ------ | ------ | ------ |
| 유기견 입양 예측 | sckit_learn, LGBM | ![Team](https://img.shields.io/badge/Team-red) | 23.06.15 ~ 23.06.21 | 유기견 보호소 데이터를 활용한 입양 확률 예측 | [Repo](https://github.com/Blessian/predict_dog_adoption) |
