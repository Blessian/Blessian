...
| ------ | ------ | ------ | ------ | ------ | ------ |
| 위로봇 | Arduino, OpenAI(GPT-4o-mini, TTS), FastAPI, SQLAlchemy, MQTT, OpenCV, Mediapipe | ![Team](https://img.shields.io/badge/3-Team-CD1818) | ![Static Badge](https://img.shields.io/badge/3-week-47B5FF) | [![Static Badge](https://img.shields.io/badge/Repo_Link-713ABE)](https://github.com/Blessian/gyeonggi_robotics_final_project) |  |
