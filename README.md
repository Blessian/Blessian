...
| ------ | ------ | ------ | ------ | ------ |
| 메타인지 능력 향상을 위한 글쓰기 플랫폼 | Langchain, OpenAI(GPT-4), FastAPI, SQLite | ![Team](https://img.shields.io/badge/Team-red) | 23.08.28 ~ 23.09.27 | [ORG Repo](https://github.com/SEP-proj)<br>[AI Repo](https://github.com/Blessian/MetaTraining_AI/tree/main) |
